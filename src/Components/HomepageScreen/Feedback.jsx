        ...
        <img src={blob} alt="" className='blob_a blob3' />
            ...
            <div className='feedSection'>
                <div className='feedinfo'>
                    <p className="info">For Being <mark>Amazing</mark>.Let's Become a part of a amazing community <mark>Code-Byte</mark>.You can even Tell your <mark>Issues Related to Website for Improvment</mark></p>
                </div>
